    ...
    public class Ammeter : ShapeControl
    {
        ...
        public override void Paint(Point location)
        {
            ...
            using (dc)
            {
                ...
                //左斜线
                dc.DrawLine(pen, new Point(location.X + 12, location.Y + 22), new Point(location.X + 20, location.Y + 1));
                //右斜线
                dc.DrawLine(pen, new Point(location.X + 20, location.Y + 1), new Point(location.X + 28, location.Y + 22));
                //横线
                dc.DrawLine(pen, new Point(location.X + 16, location.Y + 13), new Point(location.X + 24, location.Y + 13));
                //右横线
