    ...
    public class Voltmeter : ShapeControl
    {
        ...
        public override void Paint(Point location)
        {
            ...
            using (dc)
            {
                ...
                //右斜线
                dc.DrawLine(pen, new Point(location.X + 12, location.Y + 4), new Point(location.X + 20, location.Y + 24));
                //左斜线
                dc.DrawLine(pen, new Point(location.X + 20, location.Y + 24), new Point(location.X + 28, location.Y + 4));
                //右横线
